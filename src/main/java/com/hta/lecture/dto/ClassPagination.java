...
public class ClassPagination {
	...
	private int rowsPerPage = 12;			// 한 페이지당 표시할 데이터의 갯수
	 ...
	 */
	public ClassPagination(int pageNo, int totalRecords) {
	 ...
	 */
	public ClassPagination(int pageNo, int totalRecords, int rows) {
